#Мы будем парсить данные с сайта https://tomsk
# .hh.ru/vacancies/programmist и сохранять их в csv-файл.
...
with open("ht.csv", 'w', newline='', encoding='utf-8') as file:
...
#Чтобы удобнее просмотреть результат, открываем файл через
# программу для чтения и редактирования таблиц.